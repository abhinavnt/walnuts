...
export function ProductForm({ productToEdit, onSubmitSuccess }: ProductFormProps) {
  ...
  return (
    <Card className="p-4 sm:p-6 w-full max-w-4xl mx-auto">
      <h3 className="text-lg font-semibold text-[#651C32] mb-4 sm:mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-4">
            <button
              ...
              className="px-4 py-2 bg-[#651C32] text-white rounded-lg hover:bg-[#4a1423] transition-colors w-full sm:w-auto"
            >
              Upload Image
            </button>
            {image && (
              <div className="relative inline-block">
                <img src={image || "/placeholder.svg"} alt="Product" className="w-32 h-32 object-cover rounded-lg" />
                <button
                  type="button"
